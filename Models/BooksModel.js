  ...
  [
    {
      ...
      //may need to make this it's own model and import the system into this model
      //this will allow you to tie each rating to a book
      rating: {
        type: mongoose.Mixed,
        ...
        default: { 1: 1, 2: 1, 3: 1, 4: 1, 5: 1 }, //the key is the weight of that star level
      },
    },
  ],
